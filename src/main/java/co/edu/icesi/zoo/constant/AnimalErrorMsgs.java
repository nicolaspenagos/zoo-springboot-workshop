...
public class AnimalErrorMsgs {
    ...
    public final static String WRONG_PYTHON_CHARACTERISTICS_MSG = String.format("Wrong specie characteristics: age must be between 0 and %1$S (years), height between 0 and %2$S (meters) and weight between 0 and %3$S (kg)", BurmesePython.MAX_AGE, BurmesePython.MAX_HEIGHT, BurmesePython.MAX_WEIGHT);
